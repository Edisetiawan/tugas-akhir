...
$arr=tampilBuku();    
  ...
  <?php  } ?>
            ...
            $posisi=($halaman-1) * $batas;
                        ...
                        $tabel_row=mysql_real_escape_string(strip_tags($_POST['cari']));
                        $data_inputan=mysql_real_escape_string(strip_tags($_POST['data_inputan']));
                        $query=mysql_query("select * from buku where ".$tabel_row."  like '%".$data_inputan."%'  ");// where  LIMIT $posisi,$batas");
                        ...
                        <div class="row">
                           ...
                           ?>
                            ...
                            <a href="?page=detail_buku&id=<?php echo $data['buku_id']; ?>"><img class="img-responsive img-hover thumbnail" src="images/<?php echo $data['buku_foto'] ?>" alt=""></a>
                                <h4>
                                    <a href="?page=detail&id=<?php echo $data['buku_id']; ?>"><?php echo $data['buku_judul']; ?></a>
                                </h4>
                                <p><small><?php echo $data['buku_judul']; ?></small></p>
                            </div>
                           <?php
                           }
