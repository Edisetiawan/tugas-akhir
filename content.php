...
//print_r($arr); exit;
    foreach($arr as $key=>$value)
    {
       ...
       <?php  } ?>
          ...
          <a href="?page=detail_buku&id=<?php echo $value['buku_id']; ?>" class="thumbnail"><img class="img-responsive" src="images/<?php echo $value['buku_foto'] ?>" alt="Thumb21"></a>
          </div>
  <?php  } ?>
</div>
</div>
...
$posisi=($halaman-1) * $batas;
                        ...
                        $query=mysql_query("select * from buku order by buku_id LIMIT $posisi,$batas ");
                        $no=0;
                        ...
                        <div class="row">
                           ...
                           ?>
                            ...
                            <a href="?page=detail_buku&id=<?php echo $data['buku_id']; ?>"><img class="img-responsive img-hover thumbnail" src="images/<?php echo $data['buku_foto'] ?>" alt=""></a>
                                <h4>
                                    <a href="?page=detail_buku&id=<?php echo $data['buku_id']; ?>"><?php echo $data['buku_judul']; ?></a>
                                </h4>
                                <p><small><?php echo word_limiter($data['buku_sinopsis'],5); ?></small></p>
                            </div>
                           <?php
                           }
                            ?>
